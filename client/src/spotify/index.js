...
export const getAccessToken = () => {
  ...
  console.log('✅ Spotify token:' + localAccessToken);

  return localAccessToken;
};

export const spotifyToken = getAccessToken();
...
/**
 * Get an Artist based on input
 * https://developer.spotify.com/documentation/web-api/reference/artists/get-artist/
 */
export const getArtistByInput = () => {
  axios.get('https://api.spotify.com/v1/search?type=track', {
    headers,
  });
};
